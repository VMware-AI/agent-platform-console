  ...
  <section class="login-page">
    ...
    <div class="login-card" role="region" :aria-label="locale.t('login.heading')">
      <aside class="login-brand">
        <div>
          <h1 class="login-brand-title">{{ brand.title || locale.t('app.title') }}</h1>
          <p class="login-brand-tagline">{{ brand.subtitle || locale.t('login.tagline') }}</p>
        </div>
        <small class="login-brand-meta">{{ brand.copyright || locale.t('login.copyright') }}</small>
      </aside>
