...
export const STRINGS: Dict = {
  ...
  // Model routing
  'gatewayModel.title': { zh: '网关模型配置', en: 'Gateway Model Configuration' },
  'gatewayModel.toast.actionFailed': { zh: '操作失败', en: 'Action failed' },
  'gatewayModel.description': { zh: '管理网关上的模型清单（供应商、路由策略、限流配额），按策略将请求分派到不同后端模型。', en: 'Manage the gateway model catalogue (supplier, routing strategy, rate-limit quota); dispatch requests to backend models by strategy.' },
  'gatewayModel.table.label': { zh: '网关模型列表', en: 'Gateway models' },
  ...
  'gatewayModel.filter.namePlaceholder': { zh: '输入模型名称', en: 'Enter model name' },
  ...
  'gatewayModel.action.create': { zh: '新建模型', en: 'New Model' },
  ...
  'gatewayModel.batch.disabled': { zh: '请先选择模型', en: 'Select models first' },
  'gatewayModel.col.selectAll': { zh: '选择当前页全部模型', en: 'Select all models on this page' },
  'gatewayModel.col.selectRoute': { zh: '选择模型 {name}', en: 'Select model {name}' },
  'gatewayModel.col.name': { zh: '模型名称', en: 'Model Name' },
  ...
  'gatewayModel.empty': { zh: '暂无网关模型', en: 'No gateway models' },
  ...
  'gatewayModel.pagination.label': { zh: '网关模型分页', en: 'Gateway model pagination' },
  'gatewayModel.form.createTitle': { zh: '新建网关模型', en: 'New Gateway Model' },
  'gatewayModel.form.editTitle': { zh: '编辑网关模型', en: 'Edit Gateway Model' },
  'gatewayModel.form.name': { zh: '模型名称', en: 'Model Name' },
  ...
  'gatewayModel.confirm.deleteTitle': { zh: '确认删除网关模型', en: 'Delete Gateway Model' },
  'gatewayModel.confirm.deleteBody': {
    zh: '确定要删除模型“{name}”吗？此操作无法撤销。',
    en: 'Delete model “{name}”? This action cannot be undone.',
  },
  'gatewayModel.confirm.batchDeleteTitle': { zh: '确认批量删除', en: 'Delete Selected Models' },
  'gatewayModel.confirm.batchDeleteBody': {
    zh: '确定要删除选中的 {count} 个模型吗？此操作无法撤销。',
    en: 'Delete the selected {count} models? This action cannot be undone.',
  },
  'gatewayModel.toast.created': { zh: '网关模型已创建', en: 'Gateway model created' },
  'gatewayModel.toast.updated': { zh: '网关模型已更新', en: 'Gateway model updated' },
  ...
  'gatewayModel.toast.enabled': {
    zh: '已启用 {count} 个网关模型',
    en: 'Enabled {count} gateway models',
  },
  'gatewayModel.toast.disabled': {
    zh: '已禁用 {count} 个网关模型',
    en: 'Disabled {count} gateway models',
  },
  'gatewayModel.toast.deleted': {
    zh: '已删除 {count} 个网关模型',
    en: 'Deleted {count} gateway models',
  },
  'gatewayModel.toast.manageGateway': {
    zh: '正在打开“{name}”的网关管理配置',
    en: 'Opening gateway configuration for “{name}”',
  },
  'gatewayModel.toast.refreshed': { zh: '网关模型列表已刷新', en: 'Gateway models refreshed' },
