...
export const STRINGS: Dict = {
  ...
  'nav.obs.metering.settings': { zh: '计量设置', en: 'Metering Settings' },
  ...
  'branding.desc': {
    zh: '自定义平台Logo、标题、登录页和汇率显示',
    en: 'Customize platform logo, title, login page and currency rates',
  },
  'branding.logo': { zh: 'Logo替换', en: 'Logo' },
