...
const STRINGS: Dict = {
  ...
  'marketplace.deploy.targetPool':   { zh: 'vSphere 资源池（可选）', en: 'vSphere resource pool (optional)' },
  'marketplace.deploy.targetPoolPlaceholder':{ zh: '真实 OVA 模板部署时必填', en: 'Required for real OVA template deploys' },
