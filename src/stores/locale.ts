...
export const STRINGS: Dict = {
  ...
  'nav.agents.list': { zh: '智能体实例', en: 'Agent Instances' },
  ...
  'branding.appTitle': { zh: '标题替换', en: 'Title' },
  'branding.loginBg': { zh: '登录页图形', en: 'Login Background' },
  'branding.currency': { zh: '汇率对比', en: 'Currency Rates' },
  'branding.default': { zh: '使用默认', en: 'Default' },
  'branding.save': { zh: '保存', en: 'Save' },
  'branding.saved': { zh: '已保存', en: 'Saved' },
  'branding.error': { zh: '保存失败', en: 'Save failed' },
  /* ---------- 许可管理 / License (LicenseView) ---------- */
  'license.title': { zh: '许可管理', en: 'License Management' },
  'license.desc': {
    zh: '平台默认 90 天试用；正式许可与首个资源池的 vCenter IP 绑定，凭该 IP 向厂商申请。',
    en: 'The platform runs a 90-day trial by default; a permanent license is bound to the first resource pool vCenter IP — apply with that IP.',
  },
  'license.mode.trial': { zh: '试用中', en: 'Trial' },
  'license.mode.licensed': { zh: '正式许可', en: 'Licensed' },
  'license.mode.expired': { zh: '已过期', en: 'Expired' },
  'license.daysLeft': { zh: '天剩余', en: 'days left' },
  'license.customer': { zh: '客户', en: 'Customer' },
  'license.edition': { zh: '版本', en: 'Edition' },
  'license.expires': { zh: '到期时间', en: 'Expires' },
  'license.trialNote': {
    zh: '试用到期后管理操作将被锁定，请及时申请并激活正式许可。',
    en: 'Management operations are locked after the trial expires — apply for and activate a license in time.',
  },
  'license.bindInfo': { zh: '绑定信息', en: 'Binding Info' },
  'license.bindDesc': {
    zh: '正式许可绑定首个接入资源池的 vCenter IP；更换 vCenter 后需重新申请。',
    en: 'A license binds to the first onboarded resource pool vCenter IP; re-apply after replacing the vCenter.',
  },
  'license.noPool': { zh: '尚未接入资源池', en: 'No resource pool yet' },
  'license.copy': { zh: '复制', en: 'Copy' },
  'license.copied': { zh: '已复制', en: 'Copied' },
  'license.copyFailed': { zh: '复制失败', en: 'Copy failed' },
  'license.step1': { zh: '① 查看上方绑定 IP', en: '1. Note the binding IP above' },
  'license.step2': { zh: '② 凭该 IP 向厂商申请许可', en: '2. Apply to the vendor with that IP' },
  'license.step3': {
    zh: '③ 将厂商签发的许可密钥粘贴到下方',
    en: '3. Paste the issued license key below',
  },
  'license.step4': {
    zh: '④ 点击激活，状态变为「正式许可」',
    en: '4. Click activate — status turns Licensed',
  },
  'license.activate': { zh: '激活许可', en: 'Activate License' },
  'license.keyPlaceholder': { zh: '粘贴厂商签发的许可密钥…', en: 'Paste the issued license key…' },
  'license.activateBtn': { zh: '激活', en: 'Activate' },
  'license.keyRequired': { zh: '请先粘贴许可密钥', en: 'Paste a license key first' },
  'license.activated': { zh: '许可激活成功', en: 'License activated' },
  'license.activateError': { zh: '激活失败', en: 'Activation failed' },
  'branding.basicInfo': { zh: '基础品牌信息', en: 'Basic Info' },
  'branding.platformName': { zh: '平台名称', en: 'Platform Name' },
  'branding.shortName': { zh: '平台简称', en: 'Short Name' },
  'branding.browserTitle': { zh: '浏览器标题', en: 'Browser Title' },
  'branding.loginSubtitle': { zh: '登录页副标题', en: 'Login Subtitle' },
  'branding.assets': { zh: '品牌资源', en: 'Brand Assets' },
  'branding.favicon': { zh: 'Favicon', en: 'Favicon' },
  'branding.theme': { zh: '界面主题', en: 'Theme' },
  'branding.primaryColor': { zh: '品牌主色', en: 'Primary Color' },
  'branding.overlay': { zh: '背景遮罩', en: 'Overlay' },
  'branding.overlayEnable': { zh: '启用登录页背景遮罩', en: 'Enable overlay' },
  'branding.cardPos': { zh: '登录卡片位置', en: 'Card Position' },
  'branding.footer': { zh: '页脚信息', en: 'Footer' },
  'branding.copyright': { zh: '版权信息', en: 'Copyright' },
  'branding.support': { zh: '技术支持', en: 'Support' },
  'branding.supportUrl': { zh: '技术支持链接', en: 'Support URL' },
  'branding.preview': { zh: '实时预览', en: 'Preview' },
  'branding.unsaved': { zh: '有未保存的更改', en: 'Unsaved changes' },
  'branding.tooLarge': { zh: '文件大小不能超过{n}', en: 'File too large (max {n})' },

  /* ---------- 计量设置 (MeteringSettings: currency & cost rules) ---------- */
  'meteringSetting.title': { zh: '计量设置', en: 'Metering Settings' },
  'meteringSetting.desc': {
    zh: '配置汇率及成本计算规则',
    en: 'Configure currency rates and cost rules',
  },
  'meteringSetting.currency': { zh: '货币与汇率', en: 'Currency & Rates' },
  'meteringSetting.gotoSettings': { zh: '计量设置', en: 'Settings' },
  'meteringSetting.tabCurrency': { zh: '货币与汇率', en: 'Currency & Rates' },
  'meteringSetting.tabCostRules': { zh: '成本规则', en: 'Cost Rules' },
  'meteringSetting.baseCurrency': { zh: '基准币种', en: 'Base Currency' },
  'meteringSetting.baseCurrencyHint': {
    zh: '基准币种用于将不同模型和供应商的成本归一为统一货币',
    en: 'Base currency normalizes costs across models and providers',
  },
  'meteringSetting.displayCurrency': { zh: '默认展示币种', en: 'Display Currency' },
  'meteringSetting.displayCurrencyHint': {
    zh: '只影响前端展示，不修改原始费用',
    en: 'Affects display only, does not modify original cost',
  },
  'meteringSetting.precision': { zh: '金额显示精度', en: 'Amount Precision' },
  'meteringSetting.digits': { zh: '位', en: 'digits' },
  'meteringSetting.precisionHint': {
    zh: '只控制前端展示，后端保留高精度',
    en: 'Frontend display only, backend preserves full precision',
  },
  'meteringSetting.preserveOriginal': { zh: '保留原始费用', en: 'Preserve Original Amount' },
  'meteringSetting.preserveOriginalHint': {
    zh: '保留模型调用的原始金额、币种及汇率快照（始终开启）',
    en: 'Preserve original amount, currency and rate snapshot (always on)',
  },
  'meteringSetting.exchangeRate': { zh: '汇率管理', en: 'Exchange Rates' },
  'meteringSetting.addRate': { zh: '添加汇率', en: 'Add Rate' },
  'meteringSetting.editRate': { zh: '编辑汇率', en: 'Edit Rate' },
  'meteringSetting.currencyPair': { zh: '币种对', en: 'Currency Pair' },
  'meteringSetting.conversionRelation': { zh: '换算关系', en: 'Conversion' },
  'meteringSetting.rateValue': { zh: '汇率值', en: 'Rate' },
  'meteringSetting.source': { zh: '来源', en: 'Source' },
  'meteringSetting.status': { zh: '状态', en: 'Status' },
  'meteringSetting.effectiveFrom': { zh: '生效时间', en: 'Effective From' },
  'meteringSetting.effectiveTo': { zh: '失效时间', en: 'Effective To' },
  'meteringSetting.updatedAt': { zh: '更新时间', en: 'Updated At' },
  'meteringSetting.updatedBy': { zh: '更新人', en: 'Updated By' },
  'meteringSetting.actions': { zh: '操作', en: 'Actions' },
  'meteringSetting.edit': { zh: '编辑', en: 'Edit' },
  'meteringSetting.deactivate': { zh: '停用', en: 'Deactivate' },
  'meteringSetting.history': { zh: '历史', en: 'History' },
  'meteringSetting.manual': { zh: '手动维护', en: 'Manual' },
  'meteringSetting.system': { zh: '系统默认', en: 'System' },
  'meteringSetting.active': { zh: '启用', en: 'Active' },
  'meteringSetting.inactive': { zh: '停用', en: 'Inactive' },
  'meteringSetting.targetCurrency': { zh: '目标币种', en: 'Target Currency' },
  'meteringSetting.note': { zh: '备注', en: 'Note' },
  'meteringSetting.notePlaceholder': { zh: '可选备注', en: 'Optional note' },
  'meteringSetting.cancel': { zh: '取消', en: 'Cancel' },
  'meteringSetting.confirmDeactivate': {
    zh: '确认停用此汇率？已产生账单不受影响。',
    en: 'Deactivate this rate? Existing bills are unaffected.',
  },
  'meteringSetting.conversionPreview': { zh: '换算验证', en: 'Conversion Preview' },
  'meteringSetting.conversionPreviewHint': {
    zh: '换算验证只用于确认配置，不创建账单',
    en: 'For verification only, does not create bills',
  },
  'meteringSetting.amount': { zh: '金额', en: 'Amount' },
  'meteringSetting.fromCurrency': { zh: '原始币种', en: 'From' },
  'meteringSetting.toCurrency': { zh: '目标币种', en: 'To' },
  'meteringSetting.useRate': { zh: '使用汇率', en: 'Using Rate' },
  'meteringSetting.calculating': { zh: '计算中...', en: 'Calculating...' },
  'meteringSetting.previewError': { zh: '未找到有效汇率', en: 'No active rate found' },
  'meteringSetting.previewValidationError': {
    zh: '请输入有效金额并选择币种',
    en: 'Enter valid amount and select currencies',
  },
  'meteringSetting.historyTitle': { zh: '汇率历史', en: 'Rate History' },
  'meteringSetting.noHistory': { zh: '暂无历史版本', en: 'No history' },
  'meteringSetting.loading': { zh: '加载中...', en: 'Loading...' },
  'meteringSetting.noRates': { zh: '暂无汇率记录', en: 'No exchange rates configured' },
  'meteringSetting.missingPriceTitle': { zh: '价格缺失处理', en: 'Missing Price Handling' },
  'meteringSetting.missingPriceDesc': {
    zh: '当模型未配置价格时如何处理费用计算',
    en: 'How to handle cost calculation when model price is not configured',
  },
  'meteringSetting.notConfigured': { zh: '尚未配置', en: 'Not configured' },
  'meteringSetting.markPending': {
    zh: '标记为价格待配置，调用继续',
    en: 'Mark as pending, continue calls',
  },
  'meteringSetting.zeroAlert': { zh: '按0临时计算并产生告警', en: 'Calculate as 0 with alert' },
  'meteringSetting.rejectRecord': { zh: '拒绝生成费用记录', en: 'Reject cost record generation' },
  'meteringSetting.failedRequestTitle': { zh: '失败请求成本', en: 'Failed Request Costs' },
  'meteringSetting.failedRequestDesc': {
    zh: '是否计算失败请求已产生的Token费用',
    en: 'Charge token costs for failed requests',
  },
  'meteringSetting.cacheTokenTitle': { zh: '缓存Token计算', en: 'Cache Token Calculation' },
  'meteringSetting.cacheRead': { zh: '计算缓存读取Token', en: 'Count cache read tokens' },
  'meteringSetting.cacheWrite': { zh: '计算缓存写入Token', en: 'Count cache write tokens' },
  'meteringSetting.roundingTitle': { zh: '金额舍入规则', en: 'Rounding Rule' },
  'meteringSetting.roundHalfUp': { zh: '四舍五入', en: 'Round Half Up' },
  'meteringSetting.roundUp': { zh: '向上取整', en: 'Round Up' },
  'meteringSetting.roundDown': { zh: '向下取整', en: 'Round Down' },
  'meteringSetting.forecastTitle': { zh: '月末费用预测', en: 'Month-End Forecast' },
  'meteringSetting.dailyAverage': { zh: '按当月日均线性预测', en: 'Daily average this month' },
  'meteringSetting.last7Days': { zh: '按最近7天日均预测', en: 'Last 7 days average' },
  'meteringSetting.noForecast': { zh: '不显示预测', en: 'No forecast' },
  'meteringSetting.alertTitle': { zh: '告警设置', en: 'Alert Settings' },
  'meteringSetting.alertMissingPrice': { zh: '价格缺失告警', en: 'Missing price alert' },
  'meteringSetting.alertMissingRate': { zh: '汇率缺失告警', en: 'Missing rate alert' },
  'meteringSetting.alertBudget': { zh: '月度预算告警', en: 'Monthly budget alert' },
  'meteringSetting.alertSpike': { zh: '用量异常增长告警', en: 'Usage spike alert' },

  /* ---------- 技能管理页 (Skills Management view) ---------- */
  'skills.title': { zh: '技能管理', en: 'Skill Management' },
  'skills.description': {
    zh: '统一管理 OpenClaw、OpenCode、Hermes 等智能体可使用的技能与能力扩展。',
    en: 'Manage the skills and capability extensions available to OpenClaw, OpenCode, Hermes and other agents.',
  },
  'skills.meta.aria': { zh: '技能统计', en: 'Skills overview' },
  'skills.meta.total': { zh: '总技能', en: 'Total skills' },
  'skills.meta.filtered': { zh: '当前显示', en: 'Shown' },
  'skills.meta.selected': { zh: '已选中', en: 'Selected' },
  'skills.search.placeholder': {
    zh: '搜索 Skill 名称、标识或描述',
    en: 'Search by name, identifier or description',
  },
  'skills.filter.category.all': { zh: '全部分类', en: 'All categories' },
  'skills.filter.status.all': { zh: '全部状态', en: 'All statuses' },
  'skills.action.refresh': { zh: '刷新', en: 'Refresh' },
  'skills.action.create': { zh: '新增 Skill', en: 'New skill' },
  'skills.action.edit': { zh: '编辑', en: 'Edit' },
  'skills.action.install': { zh: '安装', en: 'Install' },
  'skills.action.installToAgent': { zh: '安装到 Agent', en: 'Install to agent' },
  'skills.action.delete': { zh: '删除', en: 'Delete' },
  'skills.action.cancel': { zh: '取消', en: 'Cancel' },
  'skills.action.retry': { zh: '重新加载', en: 'Retry' },
  'skills.action.clearFilter': { zh: '清除筛选条件', en: 'Clear filters' },
  'skills.action.sync': { zh: '在线下载', en: 'Download' },
  'skills.action.syncing': { zh: '同步中...', en: 'Syncing...' },
  'skills.action.upload': { zh: '上传到离线库', en: 'Upload to offline repo' },
  'skills.action.uploading': { zh: '上传中...', en: 'Uploading...' },
  'skills.action.save': { zh: '保存修改', en: 'Save changes' },
  'skills.action.submit': { zh: '创建 Skill', en: 'Create skill' },
  'skills.error.loadFailed.title': { zh: 'Skills 列表加载失败', en: 'Failed to load skills' },
  'skills.error.network': { zh: '网络错误：{message}', en: 'Network error: {message}' },
  'skills.error.unknown': { zh: '未知错误', en: 'Unknown error' },
  'skills.empty.title': { zh: '暂无 Skills', en: 'No skills yet' },
  'skills.empty.description': {
    zh: '创建 Skills，为 OpenClaw、OpenCode、Hermes 等智能体扩展企业级能力。',
    en: 'Create skills to extend the enterprise capabilities available to OpenClaw, OpenCode, Hermes and other agents.',
  },
  'skills.empty.create': { zh: '新增第一个 Skill', en: 'Create the first skill' },
  'skills.empty.filteredTitle': {
    zh: '未找到符合条件的 Skills',
    en: 'No skills match the filters',
  },
  'skills.empty.filteredDesc1': {
    zh: '没有匹配「{query}」的 Skills',
    en: 'No skills match "{query}"',
  },
  'skills.empty.filteredDesc2': {
    zh: '当前筛选条件下没有符合条件的 Skills',
    en: 'No skills match the current filters',
  },
  'skills.col.name': { zh: 'Skill', en: 'Skill' },
  'skills.col.description': { zh: '描述', en: 'Description' },
  'skills.col.category': { zh: '分类', en: 'Category' },
  'skills.col.agent': { zh: 'Agent', en: 'Agent' },
  'skills.col.version': { zh: '版本', en: 'Version' },
  'skills.col.installMethod': { zh: '安装方式', en: 'Install method' },
  'skills.col.status': { zh: '状态', en: 'Status' },
  'skills.col.actions': { zh: '操作', en: 'Actions' },
  'skills.agentTypes.all': { zh: '全部', en: 'All' },
  'skills.status.enabled': { zh: '已启用', en: 'Enabled' },
  'skills.status.disabled': { zh: '已停用', en: 'Disabled' },
  'skills.dialog.createTitle': { zh: '新增 Skill', en: 'New skill' },
  'skills.dialog.editTitle': { zh: '编辑 Skill', en: 'Edit skill' },
  'skills.dialog.section.basic': { zh: '基础信息', en: 'Basic information' },
  'skills.dialog.section.install': { zh: '安装信息', en: 'Installation' },
  'skills.dialog.section.offline': { zh: '离线包部署', en: 'Offline package' },
  'skills.dialog.section.mcp': { zh: 'MCP 配置（可选）', en: 'MCP configuration (optional)' },
  'skills.dialog.field.id': { zh: 'Skill 标识', en: 'Skill ID' },
  'skills.dialog.field.idHelp': {
    zh: '仅支持小写字母、数字和短横线，创建后不可修改',
    en: 'Lowercase letters, digits and hyphens only. Cannot be changed after creation.',
  },
  'skills.dialog.field.idPlaceholder': { zh: 'vmware-aiops', en: 'vmware-aiops' },
  'skills.dialog.field.name': { zh: 'Skill 名称', en: 'Skill name' },
  'skills.dialog.field.namePlaceholder': { zh: 'VMware 智能运维', en: 'VMware AIOps' },
  'skills.dialog.field.description': { zh: '描述', en: 'Description' },
  'skills.dialog.field.descriptionPlaceholder': {
    zh: '描述该 Skill 能为智能体提供什么能力',
    en: 'Describe what this skill enables for agents',
  },
  'skills.dialog.field.category': { zh: '分类', en: 'Category' },
  'skills.dialog.field.none': { zh: '无', en: 'None' },
  'skills.dialog.field.agentTypes': { zh: '适用 Agent', en: 'Available agents' },
  'skills.dialog.field.installMethod': { zh: '安装方式', en: 'Install method' },
  'skills.dialog.field.uri': { zh: '源包 URL', en: 'Package URL' },
  'skills.dialog.field.uriPlaceholder': {
    zh: 'https://pypi.org/project/example/',
    en: 'https://pypi.org/project/example/',
  },
  'skills.dialog.field.version': { zh: '版本', en: 'Version' },
  'skills.dialog.field.versionPlaceholder': { zh: '1.0.0', en: '1.0.0' },
  'skills.dialog.field.repoBase': { zh: '离线仓库地址', en: 'Offline repository URL' },
  'skills.dialog.field.repoBaseHelp': {
    zh: 'Agent VM 通过此地址下载离线包。同步/上传后 Skills 包会存到此仓库。',
    en: 'Agent VMs download offline packages from this URL. Synced/uploaded skill packages are stored here.',
  },
  'skills.dialog.field.pkg': { zh: '离线包 URL', en: 'Offline package URL' },
  'skills.dialog.field.syncHelp': {
    zh: '输入 URL 后点击「在线下载」→ 后端下载并推送到跳板机离线库',
    en: 'Enter a URL and click "Download" — the backend fetches the package and pushes it to the offline repo on the bastion host.',
  },
  'skills.dialog.field.upload': { zh: '本地上传', en: 'Local upload' },
  'skills.dialog.field.uploadHelp': {
    zh: '选择本地 .tar.gz 文件上传到跳板机',
    en: 'Select a local .tar.gz file to upload to the bastion host.',
  },
  'skills.dialog.upload.choose': { zh: '选择文件', en: 'Choose file' },
  'skills.dialog.upload.noFile': { zh: '未选择任何文件', en: 'No file selected' },
  'skills.dialog.warn.packageNotReady': {
    zh: '⚠ 离线包尚未同步到跳板机，部署时无法安装',
    en: '⚠ Offline package has not been synced to the bastion host and cannot be installed at deployment time.',
  },
  'skills.dialog.ok.packageReady': {
    zh: '✓ 离线包已就绪：{url}',
    en: '✓ Offline package ready: {url}',
  },
  'skills.dialog.field.agentIp': { zh: 'Agent IP 地址', en: 'Agent IP address' },
  'skills.dialog.field.agentIpHelp': {
    zh: '输入已运行 Agent 的 IP，将自动 SSH 安装离线包。',
    en: 'Enter the IP of a running agent; the offline package will be installed via SSH automatically.',
  },
  'skills.dialog.installTitle': { zh: '安装 {name} 到 Agent', en: 'Install {name} on agent' },
  'skills.dialog.error.invalidId': {
    zh: '标识仅支持小写字母、数字和短横线',
    en: 'Identifier may only contain lowercase letters, digits and hyphens',
  },
  'skills.dialog.error.requiredName': { zh: '请输入名称', en: 'Name is required' },
  'skills.dialog.error.requiredDesc': { zh: '请输入描述', en: 'Description is required' },
  'skills.dialog.error.requiredUri': { zh: '请输入源包 URL', en: 'Package URL is required' },
  'skills.dialog.error.invalidJson': {
    zh: 'MCP 配置 JSON 不合法',
    en: 'MCP configuration JSON is invalid',
  },
  'skills.dialog.error.invalidIp': {
    zh: '请输入有效的 IP 地址',
    en: 'Please enter a valid IP address',
  },
  'skills.confirm.deleteTitle': { zh: '删除 Skill', en: 'Delete skill' },
  'skills.confirm.deleteBody': {
    zh: '确定要删除 Skill「{name}」吗？此操作不可恢复。',
    en: 'Delete skill "{name}"? This cannot be undone.',
  },
  'skills.toast.deleted': { zh: '已删除「{name}」', en: 'Deleted "{name}"' },
  'skills.toast.deletedFail': { zh: '删除失败: {message}', en: 'Delete failed: {message}' },
  'skills.toast.created': { zh: '「{name}」已创建', en: '"{name}" created' },
  'skills.toast.updated': { zh: '「{name}」已更新', en: '"{name}" updated' },
  'skills.toast.syncOk': {
    zh: '离线包已同步到跳板机',
    en: 'Offline package synced to the bastion host',
  },
  'skills.toast.syncFail': { zh: '同步失败: {message}', en: 'Sync failed: {message}' },
  'skills.toast.uploadOk': {
    zh: '离线包已上传到跳板机',
    en: 'Offline package uploaded to the bastion host',
  },
  'skills.toast.uploadFail': { zh: '上传失败: {message}', en: 'Upload failed: {message}' },
  'skills.toast.installOk': { zh: '已在 {ip} 安装 {name}', en: 'Installed {name} on {ip}' },

  /* 安装 Skill 到 Agent 对话框 (rendered inside AgentListView.vue's row-actions
     menu). Title uses an em-dash separator; the dialog itself is bilingual. */
  'skills.installDialog.title': { zh: '安装 Skill — {name}', en: 'Install skill — {name}' },
  'skills.installDialog.empty': {
    zh: '暂无可用离线 Skill。请先在技能管理中同步离线包。',
    en: 'No offline skills available. Sync offline packages in the Skills page first.',
  },
  'skills.installDialog.checking': {
    zh: '正在检查已安装状态...',
    en: 'Checking installed status...',
  },
  'skills.installDialog.count': { zh: '离线包 {count} 个', en: '{count} offline packages' },
  'skills.installDialog.installed': { zh: '已安装', en: 'Installed' },
  'skills.installDialog.notInstalled': { zh: '未安装', en: 'Not installed' },
  'skills.installDialog.installOne': {
    zh: '安装 {count} 个 Skill',
    en: 'Install {count} skill(s)',
  },
  'skills.installDialog.installing': { zh: '安装中...', en: 'Installing...' },
  'skills.installDialog.close': { zh: '关闭', en: 'Close' },
  'skills.installDialog.prev': { zh: '上一页', en: 'Previous' },
  'skills.installDialog.next': { zh: '下一页', en: 'Next' },
  'skills.installDialog.pageOf': { zh: '第 {page} / {total} 页', en: 'Page {page} of {total}' },
  'skills.installDialog.noAgentTypes': { zh: '全部', en: 'All' },
  'skills.installDialog.installDone': {
    zh: '安装完成: {ok}/{total} 成功',
    en: 'Install finished: {ok}/{total} succeeded',
  },
  'skills.toast.installFail': { zh: '安装失败: {message}', en: 'Install failed: {message}' },

  /* 安装方式 (installMethod enum) */
  'skills.installMethod.pip': { zh: 'Python 包 (pip)', en: 'Python package (pip)' },
  'skills.installMethod.pip-requirements': { zh: 'requirements.txt', en: 'requirements.txt' },
  'skills.installMethod.npm': { zh: 'NPM 包', en: 'NPM package' },
  'skills.installMethod.binary': { zh: '二进制程序', en: 'Binary' },
  'skills.installMethod.openclaw-skill': { zh: 'OpenClaw Skill', en: 'OpenClaw skill' },
  'skills.installMethod.opencode-skill': { zh: 'OpenCode Skill', en: 'OpenCode skill' },
  'skills.installMethod.hermes-plugin': { zh: 'Hermes 插件', en: 'Hermes plugin' },

  /* 分类 (categories) — keep these identifiers stable; only display names are translated. */
  'skills.category.开发': { zh: '开发', en: 'Development' },
  'skills.category.运维': { zh: '运维', en: 'Operations' },
  'skills.category.办公': { zh: '办公', en: 'Office' },
  'skills.category.安全': { zh: '安全', en: 'Security' },
  'skills.category.数据': { zh: '数据', en: 'Data' },
  'skills.category.AI': { zh: 'AI', en: 'AI' },
  ...
  // v15 dashboard UX pass — new strings for redesigned overview (KPI cards,
  // donut + agent health, monthly usage snapshot, alerts, component health).
  'dashboard.overview.subtitle': {
    zh: '平台运行状态、服务健康、调用质量与异常概览',
    en: 'Platform health, service status, call quality and anomaly overview',
  },
  'dashboard.autoRefresh': { zh: '自动刷新', en: 'Auto-refresh' },
  'dashboard.refresh': { zh: '刷新', en: 'Refresh' },
  'dashboard.lastRefresh': { zh: '最新刷新时间', en: 'Last refreshed at' },
  'dashboard.kpi.health': { zh: '平台健康度', en: 'Platform Health' },
  'dashboard.kpi.activeAgents': { zh: '活跃智能体', en: 'Active Agents' },
  'dashboard.kpi.linkedModels': { zh: '接入模型', en: 'Linked Models' },
  'dashboard.kpi.totalCalls': { zh: '总请求量', en: 'Total Calls' },
  'dashboard.kpi.successRate': { zh: '请求成功率', en: 'Success Rate' },
  'dashboard.kpi.p95latency': { zh: 'P95响应时间', en: 'P95 Latency' },
  'dashboard.kpi.monthlyCost': { zh: '本月费用', en: 'Monthly Cost' },
  'dashboard.kpi.critical': { zh: '严重', en: 'Critical' },
  'dashboard.kpi.warning': { zh: '警告', en: 'Warning' },
  'dashboard.kpi.abnormal': { zh: '异常', en: 'Abnormal' },
  'dashboard.kpi.stopped': { zh: '停止', en: 'Stopped' },
  'dashboard.kpi.success': { zh: '成功', en: 'Success' },
  'dashboard.kpi.failed': { zh: '失败', en: 'Failed' },
  'dashboard.kpi.failedCalls': { zh: '失败请求', en: 'Failed Calls' },
  'dashboard.kpi.avgLatency': { zh: '平均延迟', en: 'Avg Latency' },
  'dashboard.kpi.clickMetering': { zh: '点击进入计量中心', en: 'Click for metering' },
  'dashboard.kpi.healthyModels': { zh: '健康模型', en: 'Healthy' },
  'dashboard.kpi.totalModels': { zh: '模型总数', en: 'Total' },
  'dashboard.qualityTrend': { zh: '调用质量', en: 'Call Quality' },
  'dashboard.compHealth': { zh: '平台组件健康', en: 'Component Health' },
  'dashboard.recentRuns': { zh: '最近智能体运行', en: 'Recent Agent Runs' },
  'dashboard.monthlyUsage': { zh: '本月用量摘要', en: 'Monthly Usage Snapshot' },
  'dashboard.alerts': { zh: '异常与待处理事项', en: 'Alerts & Pending' },
  'dashboard.quickLinks': { zh: '快捷入口', en: 'Quick Links' },
  'dashboard.projected': { zh: '预计月底费用', en: 'Projected Month-end' },
  'dashboard.change': { zh: '较上月变化', en: 'Change from prev month' },
  'dashboard.topAgent': { zh: '最高消耗智能体', en: 'Top Agent' },
  'dashboard.viewAllLogs': { zh: '查看全部请求日志', en: 'View all request logs' },
  'dashboard.gotoMetering': { zh: '进入计量中心', en: 'Go to metering' },
  'dashboard.empty': { zh: '暂无数据', en: 'No data' },
  'dashboard.col.agent': { zh: '智能体', en: 'Agent' },
  'dashboard.col.model': { zh: '模型', en: 'Model' },
  'dashboard.col.tokens': { zh: 'Token', en: 'Tokens' },
  'dashboard.col.latency': { zh: '延迟', en: 'Latency' },
  'dashboard.col.status': { zh: '状态', en: 'Status' },
  'dashboard.col.time': { zh: '时间', en: 'Time' },
  'dashboard.health.healthy': { zh: '正常', en: 'Healthy' },
  'dashboard.health.warning': { zh: '存在警告', en: 'Warning' },
  'dashboard.health.degraded': { zh: '部分异常', en: 'Degraded' },
  'dashboard.health.critical': { zh: '严重异常', en: 'Critical' },
  ...
  'dashboard.links.monitor': { zh: '实时监控', en: 'Realtime Monitor' },
  'dashboard.links.requests': { zh: '请求日志', en: 'Request Logs' },
  'dashboard.links.metering': { zh: '计量中心', en: 'Metering Center' },
  'dashboard.links.audit': { zh: '审计日志', en: 'Audit Log' },
  'dashboard.agentHealth': { zh: '智能体健康状态', en: 'Agent Health' },
  'dashboard.totalAgents': { zh: '智能体总数', en: 'Total Agents' },
  'dashboard.viewAllAgents': { zh: '查看全部智能体', en: 'View all agents' },
  'dashboard.viewMonitor': { zh: '查看实时监控', en: 'View monitor' },
  'dashboard.noAlerts': { zh: '当前暂无待处理异常', en: 'No pending alerts' },
  'dashboard.lastCheck': { zh: '平台最近检查时间', en: 'Last platform check' },
  'dashboard.compHealth.graphqlApi': { zh: '后端服务', en: 'Backend Service' },
  ...
  'agents.list.title': { zh: '智能体实例', en: 'Agent Instances' },
  ...
  'metering.source.gateway': { zh: '网关记录（litellm）', en: 'Gateway ledger (litellm)' },
  ...
  'requestLog.filter.userPlaceholder': { zh: '用户', en: 'User' },
  ...
  'requestLog.col.status.filter': { zh: '按状态筛选', en: 'Filter by status' },
  'requestLog.status.all': { zh: '全部', en: 'All' },
  'requestLog.filter.modelPlaceholder': { zh: '模型名称', en: 'Model name' },
  'requestLog.filter.agentPlaceholder': { zh: '智能体', en: 'Agent' },
  'requestLog.filter.requestPlaceholder': { zh: '请求 ID', en: 'Request ID' },
  'requestLog.col.agent.search': {
    zh: '搜索智能体（UUID 或名称）',
    en: 'Search agent (UUID or name)',
  },
  'requestLog.col.model.search': { zh: '搜索模型名称', en: 'Search model name' },
  'requestLog.col.requestId.search': { zh: '搜索请求 ID', en: 'Search request ID' },
  'requestLog.col.user.search': { zh: '搜索用户 ID 或名称', en: 'Search user (ID or name)' },
  ...
  'auditLog.col.actor.search': { zh: '搜索操作者（ID 或名称）', en: 'Search actor (ID or name)' },
  'auditLog.col.actionType.search': { zh: '选择操作类型', en: 'Choose action type' },
  'auditLog.col.resourceType.search': { zh: '搜索资源类型', en: 'Search resource type' },
  'auditLog.col.description.search': { zh: '搜索操作描述', en: 'Search operation description' },
  'auditLog.col.result.search': { zh: '选择结果', en: 'Choose result' },
  'auditLog.result.all': { zh: '全部', en: 'All' },
  ...
  'agentConfig.col.latestVersion': { zh: '最新版本', en: 'Latest Version' },
  'agentConfig.col.agentType': { zh: '智能体类型', en: 'Agent Type' },
  'agentConfig.col.createdAt': { zh: '创建时间', en: 'Created At' },
  'agentConfig.col.updatedAt': { zh: '更新时间', en: 'Updated At' },
  ...
  'agentConfig.detail.updatedAt': { zh: '更新时间', en: 'Updated At' },
  ...
  'agentDetail.backToList': { zh: '返回智能体实例', en: 'Back to Agent Instances' },
