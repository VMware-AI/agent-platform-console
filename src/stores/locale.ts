...
export const STRINGS: Dict = {
  ...
  'meteringSetting.desc': { zh: '配置汇率及成本计算规则', en: 'Configure currency rates and cost rules' },
  ...
  'meteringSetting.baseCurrencyHint': { zh: '基准币种用于将不同模型和供应商的成本归一为统一货币', en: 'Base currency normalizes costs across models and providers' },
  'meteringSetting.displayCurrency': { zh: '默认展示币种', en: 'Display Currency' },
  'meteringSetting.displayCurrencyHint': { zh: '只影响前端展示，不修改原始费用', en: 'Affects display only, does not modify original cost' },
  'meteringSetting.precision': { zh: '金额显示精度', en: 'Amount Precision' },
  'meteringSetting.digits': { zh: '位', en: 'digits' },
  'meteringSetting.precisionHint': { zh: '只控制前端展示，后端保留高精度', en: 'Frontend display only, backend preserves full precision' },
  'meteringSetting.preserveOriginal': { zh: '保留原始费用', en: 'Preserve Original Amount' },
  'meteringSetting.preserveOriginalHint': { zh: '保留模型调用的原始金额、币种及汇率快照（始终开启）', en: 'Preserve original amount, currency and rate snapshot (always on)' },
  ...
  'meteringSetting.confirmDeactivate': { zh: '确认停用此汇率？已产生账单不受影响。', en: 'Deactivate this rate? Existing bills are unaffected.' },
  'meteringSetting.conversionPreview': { zh: '换算验证', en: 'Conversion Preview' },
  'meteringSetting.conversionPreviewHint': { zh: '换算验证只用于确认配置，不创建账单', en: 'For verification only, does not create bills' },
  ...
  'meteringSetting.previewValidationError': { zh: '请输入有效金额并选择币种', en: 'Enter valid amount and select currencies' },
  ...
  'meteringSetting.missingPriceDesc': { zh: '当模型未配置价格时如何处理费用计算', en: 'How to handle cost calculation when model price is not configured' },
  'meteringSetting.notConfigured': { zh: '尚未配置', en: 'Not configured' },
  'meteringSetting.markPending': { zh: '标记为价格待配置，调用继续', en: 'Mark as pending, continue calls' },
  ...
  'meteringSetting.failedRequestDesc': { zh: '是否计算失败请求已产生的Token费用', en: 'Charge token costs for failed requests' },
  ...
  'skills.description':     { zh: '统一管理 OpenClaw、OpenCode、Hermes 等智能体可使用的技能与能力扩展。',
  ...
  'skills.search.placeholder': { zh: '搜索 Skill 名称、标识或描述',  en: 'Search by name, identifier or description' },
  ...
  'skills.empty.description': { zh: '创建 Skills，为 OpenClaw、OpenCode、Hermes 等智能体扩展企业级能力。',
  ...
  'skills.empty.filteredTitle': { zh: '未找到符合条件的 Skills',   en: 'No skills match the filters' },
  'skills.empty.filteredDesc1': { zh: '没有匹配「{query}」的 Skills', en: 'No skills match "{query}"' },
  'skills.empty.filteredDesc2': { zh: '当前筛选条件下没有符合条件的 Skills',
  ...
  'skills.dialog.field.idHelp':         { zh: '仅支持小写字母、数字和短横线，创建后不可修改',
  ...
  'skills.dialog.field.descriptionPlaceholder':{ zh: '描述该 Skill 能为智能体提供什么能力',
  ...
  'skills.dialog.field.uriPlaceholder': { zh: 'https://pypi.org/project/example/',
  ...
  'skills.dialog.field.repoBaseHelp':   { zh: 'Agent VM 通过此地址下载离线包。同步/上传后 Skills 包会存到此仓库。',
  ...
  'skills.dialog.field.syncHelp':       { zh: '输入 URL 后点击「在线下载」→ 后端下载并推送到跳板机离线库',
  ...
  'skills.dialog.field.uploadHelp':     { zh: '选择本地 .tar.gz 文件上传到跳板机',
  ...
  'skills.dialog.warn.packageNotReady': { zh: '⚠ 离线包尚未同步到跳板机，部署时无法安装',
                                            en: '⚠ Offline package has not been synced to the bastion host and cannot be installed at deployment time.' },
  'skills.dialog.ok.packageReady':      { zh: '✓ 离线包已就绪：{url}', en: '✓ Offline package ready: {url}' },
  'skills.dialog.field.agentIp':        { zh: 'Agent IP 地址',        en: 'Agent IP address' },
  'skills.dialog.field.agentIpHelp':    { zh: '输入已运行 Agent 的 IP，将自动 SSH 安装离线包。',
  ...
  'skills.dialog.error.invalidId':      { zh: '标识仅支持小写字母、数字和短横线', en: 'Identifier may only contain lowercase letters, digits and hyphens' },
  ...
  'skills.dialog.error.invalidJson':    { zh: 'MCP 配置 JSON 不合法', en: 'MCP configuration JSON is invalid' },
  'skills.dialog.error.invalidIp':      { zh: '请输入有效的 IP 地址', en: 'Please enter a valid IP address' },
  'skills.confirm.deleteTitle':         { zh: '删除 Skill',           en: 'Delete skill' },
  'skills.confirm.deleteBody':          { zh: '确定要删除 Skill「{name}」吗？此操作不可恢复。',
  ...
  'skills.toast.syncOk':                { zh: '离线包已同步到跳板机', en: 'Offline package synced to the bastion host' },
  'skills.toast.syncFail':              { zh: '同步失败: {message}',  en: 'Sync failed: {message}' },
  'skills.toast.uploadOk':              { zh: '离线包已上传到跳板机', en: 'Offline package uploaded to the bastion host' },
  ...
  'skills.installDialog.empty':          { zh: '暂无可用离线 Skill。请先在技能管理中同步离线包。',
                                            en: 'No offline skills available. Sync offline packages in the Skills page first.' },
  'skills.installDialog.checking':       { zh: '正在检查已安装状态...', en: 'Checking installed status...' },
  ...
  'skills.installDialog.installOne':     { zh: '安装 {count} 个 Skill', en: 'Install {count} skill(s)' },
  ...
  'skills.installDialog.installDone':    { zh: '安装完成: {ok}/{total} 成功', en: 'Install finished: {ok}/{total} succeeded' },
  ...
  'requestLog.col.agent.search': { zh: '搜索智能体（UUID 或名称）', en: 'Search agent (UUID or name)' },
