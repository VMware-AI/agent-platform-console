...
const STRINGS: Dict = {
  ...
  // 请求日志 (request logs)
  'requestLog.title': { zh: '请求日志', en: 'Request Logs' },
  ...
  'requestLog.col.status': { zh: '状态码', en: 'Status' },
  ...
  // 审计日志 (audit logs)
  'auditLog.title': { zh: '审计日志', en: 'Audit Logs' },
  ...
  'auditLog.filter.searchPlaceholder': { zh: '搜索动作或资源', en: 'Search action or resource' },
  ...
  'auditLog.pagination.summary': { zh: '第 {start}–{end} 条，共 {total} 条', en: '{start}–{end} of {total}' },
