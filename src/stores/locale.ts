...
const STRINGS: Dict = {
  ...
  'marketplace.toast.deployGatewayEmpty': { zh: '暂无可用模型网关，请先在「系统配置 → 模型网关接入」中接入网关', en: 'No model gateways available. Please connect one first.' },
  'marketplace.toast.credentialsReveal': { zh: '智能体 {name} 部署成功！运行账户用户名：{username} · 初始密码：{password}', en: 'Agent {name} deployed. Username: {username} · Password: {password}' },
  ...
  'marketplace.deploy.modelGateway':{ zh: '模型网关',          en: 'Model gateway' },
  'marketplace.deploy.virtualKey':  { zh: '虚拟密钥',          en: 'Virtual Key' },
  'marketplace.deploy.virtualKeyMode':{ zh: '密钥来源',        en: 'Key source' },
  'marketplace.deploy.virtualKeyMode.existing': { zh: '使用已有未绑定密钥', en: 'Use existing unbound key' },
  'marketplace.deploy.virtualKeyMode.new':      { zh: '现场新建密钥',     en: 'Create new key' },
  'marketplace.deploy.existingKey':  { zh: '选择密钥',          en: 'Select key' },
  'marketplace.deploy.noAvailableKey':{ zh: '当前网关下无未绑定密钥，请选择「现场新建密钥」', en: 'No unbound keys for this gateway — please create a new one' },
  'marketplace.deploy.newKeyName':   { zh: '新密钥名称',        en: 'New key name' },
  'marketplace.deploy.newKeyNamePlaceholder':{ zh: '如 Hermes_Key_01', en: 'e.g. Hermes_Key_01' },
  ...
  'marketplace.deploy.username':     { zh: '运行账户用户名',    en: 'Run-as username' },
  'marketplace.deploy.usernamePlaceholder':{ zh: '如 svc_openclaw_robot', en: 'e.g. svc_openclaw_robot' },
  'marketplace.deploy.password':     { zh: '初始密码',          en: 'Initial password' },
  'marketplace.deploy.confirmPassword':{ zh: '确认密码',        en: 'Confirm password' },
  'marketplace.deploy.description':  { zh: '部署说明（可选）',  en: 'Description (optional)' },
  'marketplace.deploy.submit':       { zh: '开始部署',          en: 'Deploy' },
  'marketplace.deploy.cancel':       { zh: '取消',              en: 'Cancel' },
  'marketplace.deploy.passwordMismatch':{ zh: '两次输入的密码不一致', en: 'Passwords do not match' },
  'marketplace.deploy.passwordWeak': { zh: '密码须包含大小写字母、数字、特殊符号，长度 ≥ 10', en: 'Password must include upper/lower/digit/symbol, length ≥ 10' },
  ...
  'marketplace.deploy.error.modelGateway':{ zh: '请选择模型网关', en: 'Please select a model gateway' },
  'marketplace.deploy.error.name':{ zh: '请输入智能体名称', en: 'Agent name is required' },
  'marketplace.deploy.error.username':{ zh: '请输入运行账户用户名', en: 'Username is required' },
  'marketplace.deploy.error.usernameTaken':{ zh: '运行账户用户名已被占用', en: 'Username is taken' },
  'marketplace.deploy.error.password':{ zh: '请输入密码（至少 10 位，含大小写、数字、符号）', en: 'Password required' },
  'marketplace.deploy.error.virtualKey':{ zh: '请选择或创建虚拟密钥', en: 'Please select or create a virtual key' },
