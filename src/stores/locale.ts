...
export const STRINGS: Dict = {
  ...
  'marketplace.deploy.department':   { zh: '部门（可选）',      en: 'Department (optional)' },
  'marketplace.deploy.departmentDefault':{ zh: '平台默认网关', en: 'Platform default gateway' },
  'marketplace.deploy.departmentHint':{ zh: '由该部门的网关发放虚拟密钥并注入其网关地址，留空使用平台默认网关', en: 'The department gateway issues the key and is baked into cloud-init; blank uses the platform default' },
  ...
  'department.detail.gateway': { zh: '网关连接', en: 'Gateway connection' },
  'department.gateway.default': { zh: '平台默认网关', en: 'Platform default gateway' },
  ...
  'department.create.gatewayLabel': { zh: '网关连接（可选）', en: 'Gateway connection (optional)' },
  'department.create.gatewayHint': { zh: '承载该部门 litellm 团队的网关，留空使用平台默认网关', en: 'Gateway hosting this department litellm team; blank uses the platform default' },
  ...
  'gatewayConn.badge.default': { zh: '默认', en: 'Default' },
  ...
  'gatewayConn.form.publicUrl': { zh: '公开 URL（可选）', en: 'Public URL (optional)' },
  'gatewayConn.form.publicUrlPlaceholder': { zh: '如 https://gw.vm.internal（留空回退端点）', en: 'e.g. https://gw.vm.internal (blank falls back to endpoint)' },
  'gatewayConn.form.publicUrlHint': { zh: '已部署 VM/智能体回连该网关的地址，留空则回退端点', en: 'The URL provisioned VMs/agents dial; blank falls back to the endpoint' },
  'gatewayConn.form.publicUrlError': { zh: '请输入合法的 http(s) 地址', en: 'Enter a valid http(s) URL' },
  ...
  'gatewayConn.form.isDefault': { zh: '设为平台默认网关', en: 'Set as the platform default gateway' },
  'gatewayConn.form.isDefaultHint': { zh: '无部门上下文的操作将使用默认网关；设为默认会清除其他网关的默认标记', en: 'Ops without a department context use the default; setting this clears the flag on any other gateway' },
