...
export const STRINGS: Dict = {
  ...
  'nav.group.gateway': { zh: '模型网关配置', en: 'Model Gateway' },
  ...
  'nav.gateway.policy': { zh: '网关策略', en: 'Gateway Policies' },
  ...
  'modelRoute.description': { zh: '配置模型路由规则，将请求按策略分派到不同后端模型。', en: 'Configure model routing rules to dispatch requests to different backend models by strategy.' },
