...
<template>
  <div class="basic-rows">
    <div class="cfg-row"><label>名称</label><span class="cfg-value">{{ props.agent?.name || '—' }}</span><span class="cfg-lock">🔒</span></div>
    <div class="cfg-row"><label>类型</label><span class="cfg-value">{{ typeLabel || '—' }}</span><span class="cfg-lock">🔒</span></div>
    <div class="cfg-row"><label>状态</label><span class="cfg-value"><cds-icon :shape="props.agent ? statusIcon(props.agent.status) : 'info'" size="xs" class="status-inline"></cds-icon>{{ statusLabel || '—' }}</span><span class="cfg-lock">🔒</span></div>
    ...
    <div class="cfg-row"><label>创建时间</label><span class="cfg-value muted">{{ props.agent ? fmt(props.agent.createdAt) : '—' }}</span><span class="cfg-lock">🔒</span></div>
  </div>
</template>
