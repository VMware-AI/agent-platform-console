    ...
    <div class="drawer-panel">
      ...
      <div class="drawer-body">
        <div class="form-group">
          ...
          <select v-model="fromCurrency" :disabled="isEdit" class="rate-select" :aria-label="locale.t('meteringSetting.baseCurrency')">
        ...
        <div class="form-group">
          ...
          <select v-model="toCurrency" :disabled="isEdit" class="rate-select" :aria-label="locale.t('meteringSetting.targetCurrency')">
            <option v-for="c in SUPPORTED_CURRENCIES" :key="c.code" :value="c.code">
              {{ c.code }} — {{ c.name }}
            </option>
          </select>
        ...
        <div class="form-group">
          ...
          <select v-model="source" class="rate-select" :aria-label="locale.t('meteringSetting.source')">
